...
const Modal = () => {
    ...
    return createPortal(<div id="modal1" className="modal" ref={ref}>
        <div className="modal-content row">
            ...
            <form onSubmit={handleSubmit as any} className='modalForm row col l12 xl12' >
                <br /><br />
                ...
                <div className="row col s12">
                    ...
                    <div className="input-field m6 col s12">
                        <div id='timeid'>
                            <i
                ...
                <div className=' modalattachment row col s12'>
                    <div className='input-field col s12'>
                ...
                <div className='container_btn_modal row col s12'>
                    {
                        Number(rol) === 1 && <button
                            type="submit"
                            className='btn waves-effect waves-light primary col l6 m6 s12'
                        >Agendar
                        </button>
                    }
                    ...
                    <button
                        ...
                        className='btn waves-effect waves-light red lighten-2 primary col l6 m6 s12'
                    >Cancelar
                    </button>
                </div>
